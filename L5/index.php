<?php
  ...
  $glevel = "select points from level where id = '5' ";
  ...
  if(isset($_POST['but'])){
    ...
    make_log($user[0],$answer,5,$time);
    if($answer == "core{0E09D8E813533872DB262AD6693FF654}"){
      solved($id,5,$score[0],$db);
      header("Location: ../dashboard.php");
    }else{
...
<div class="right-part nav-ele">
    ...
    <div class="landing" style = "margin-top:100px;">
      <h1>Whiteproblem </h1>
      <p>A little puzzler. (<a href = "white.png" download>Download</a>) </p>
      <img src = "white.png" style = "width: 300px; height:300px;">
